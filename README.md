...
gitGraph
   ...
   branch feature/DEVTH-100
   checkout feature/DEVTH-100
   commit id: "feat: add login"
   checkout release/v1.1.0
   merge feature/DEVTH-100 id: "Squash: DEVTH-100"
   branch fix/DEVTH-101
   checkout fix/DEVTH-101
   commit id: "fix: signup validation"
   checkout release/v1.1.0
   merge fix/DEVTH-101 id: "Squash: DEVTH-101"
   checkout main
...
**예시**
```bash
git flow feature start DEVTH-100 release/v1.1.0
```
...
```bash
# 오류: release 브랜치 미지정
git flow feature start DEVTH-100

# 오류: release가 아닌 브랜치 지정
git flow feature start DEVTH-100 main
```
...
**예시**
```bash
git flow fix start DEVTH-101 release/v1.1.0
```
